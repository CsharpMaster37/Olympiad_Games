function confirmDelete_user(userId, userName) {
  // Открыть модальное окно
  document.getElementById('confirmationTitle').innerText = 'Подтверждение удаления пользователя';
  document.getElementById('confirmationMessage').innerText = `Вы уверены, что хотите удалить пользователя "${userName}"?`;
...
function confirmDelete_progress_square(userId, userName) {
  ...
  document.getElementById('confirmationMessage').innerText = `Вы уверены, что хотите удалить прогресс "Квадрата" для пользователя "${userName}"?`;
...
function confirmDelete_progress_carousel(userId, userName) {
  // Установить сообщение для подтверждения
  document.getElementById('confirmationTitle').innerText = 'Подтверждение удаления прогресса';
  document.getElementById('confirmationMessage').innerText = `Вы уверены, что хотите удалить прогресс "Карусели" для пользователя "${userName}"?`;
